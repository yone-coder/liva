...
// Remove this line for production on Render - it's only needed for localhost
...
if (!client_id || !client_secret) {
    console.error('Missing required environment variables: CLIENT_ID and CLIENT_SECRET');
    process.exit(1);
}
...
function send_email_receipt(object) {
  const sendgrid_api_key = process.env.SENDGRID_API_KEY; // Use environment variable
